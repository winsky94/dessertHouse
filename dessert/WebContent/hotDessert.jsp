...
<head>
	...
	<style type="text/css">
		#dessertTable thead tr th {
			text-align: center;
			font-size: 16px;
			line-height: 14px;
		}

		#dessertTable tbody tr td {
			text-align: center;
			font-size: 16px;
			line-height: 14px;
			cursor: pointer;
...
<body>
		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div class="table-container table-responsive">
					<table id="dessertTable" class="table display dataTable">
						<thead>
							<tr>
								...
								<th class="order-header text-center">总销售量</th>
								<th class="order-header text-center">总销售额</th>
							</tr>
						</thead>
					</table>
				</div>
	...
	<script src="js/hotDessert.js"></script>
	<script>
		$(document).ready(function() {
			var table=$('#dessertTable').DataTable({
				"ajax": {
				    url: "api/manager/hotDessert",
				    dataSrc: 'dessertResult',
				    "data":function() {
				    	var year=$("#year").val();
				    	var month=$("#month").val();
