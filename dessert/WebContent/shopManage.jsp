	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				<!-- 操作按钮 -->
				<div>
					<a class="btn btn-small pull-right margin_button" href="#" onclick="deleteShop();">
						<i class="icon-minus"></i>删除
					</a>
					<a id="update" class="btn btn-small pull-right margin_button" href="#shopModel" role="button" data-toggle="modal" onclick="changeAction('update');">
						<i class="icon-edit"></i>修改
					</a>
					<a class="btn btn-small pull-right margin_button" href="#shopModel" role="button" data-toggle="modal" onclick="changeAction('add');">
