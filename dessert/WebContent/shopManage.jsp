			...
			<div class="row-fluid">
				...
				<div class="span2">
					<ul class="collection">
						...
						<li class="collection-item">
							<p>最近登录时间：<br> &nbsp;&nbsp;&nbsp;&nbsp; 2016-01-20 15:50:00</p>
						</li>
					</ul>
				</div>
				<!-- 左侧用户信息结束 -->
		...
		$(document).ready(function() {
    		...
    		var table=$('#shopTable').dataTable( {
			    ...
			    buttons: [
			        ...
			        { extend: "edit",   editor: editor, text: "编辑", className: "btn btn-default data-table-btn"},
			        { extend: "remove", editor: editor, text: "删除", className: "btn btn-default data-table-btn"}
			    ],
			     language: {
			        paginate: {
			            first:    '第一页',
